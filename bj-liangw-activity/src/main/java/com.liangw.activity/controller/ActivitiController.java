package com.liangw.activity.controller;

import com.alibaba.fastjson.JSONObject;
import com.liangw.activity.service.WorkFlowService;
import com.liangw.activity.util.BaseResponse;
import com.liangw.activity.util.RequestHolder;
...
public class ActivitiController {
    ...
    @ApiOperation(value="启动流程,请假pdKey:QjFlow")
    public BaseResponse startWorkflow(@RequestParam(required = false) String pdKey){
        ...
        return BaseResponse.ok("请假已提交").add("jsonObject",jsonObject);
    }
    ...
    public BaseResponse findUserProcessIds(@RequestParam String userId, @RequestParam(required = false) String pdKey) {
        ...
        // 获取流程图
        return BaseResponse.ok().add("list",workFlowService.findUserProcessIds(userId,pdKey,1,0));
    }
